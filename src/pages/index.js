...
export default function Home() {
  ...
  return (
    <>
      ...
      <section id='heroname'>
        <div className="z-4 backdrop-blur-sm  absolute left-0 right-0 m-auto top-1/3  w-full md:w-1/2 
        mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-5xl text-5xl mb-4">
            ...
            <br className=" lg:inline-block "></br>
